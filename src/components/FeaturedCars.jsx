  ...
  return (
    <section className='bg-gray-100 py-20 sm:px-16 px-4'>
        <div className='max-w-7xl mx-auto text-center mb-12'>
            <h2 className='sm:text-4xl text-3xl font-3xl font-bold mb-2 flex justify-center items-center gap-2'>
              ...
              <div key={car.id} className='bg-white rounded-xl p-4 shadow-md hover:shadow-lg transition duration-300 hover:-translate-y-3'>
                ...
                <div className='mt-4'>
                  ...
                  <div className='flex sm:flex-row flex-col mt-4 gap-3'>
                    ...
                    <button className='sm:w-1/2 w-full bg-green-600 border border-gray-300 px-3 py-2 rounded cursor-pointer transition duration-300 hover:bg-green-700'>Book Now</button>
                  </div>
                </div>
              </div>
            ))
        ...
        <button className='mx-auto flex items-center justify-center mt-12 bg-blue-500 py-3 px-5 text-white rounded cursor-pointer gap-1 transition duration-300 hover:bg-blue-800'>View All Vehicles <ArrowRight className='h-5 w-5' /></button>
    </section>
  )
}
